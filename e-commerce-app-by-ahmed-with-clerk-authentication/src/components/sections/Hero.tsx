...
import ProductCorousel from "@/app/views/ProductCorousel";
import SectionTwo from "./HeroSection2";
import Newslatter from "./Newsletter";

const Hero = () => {
  return (
    <>
      <div className="flex md:px-28 py-14 flex-col  lg:flex-row gap-y-2">
        ...
        <div className="md:flex-1 md:ml-56 mt-10">
          <Image
