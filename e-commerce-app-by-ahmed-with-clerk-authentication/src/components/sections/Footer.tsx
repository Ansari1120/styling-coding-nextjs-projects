  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col lg:flex-row justify-items-center border-t-2 p-4 border-black justify-evenly text-lg text-gray-500  pl-[4px] pb-[40px] gap-4 lg:pl-[26px] ">
        <div className="basis-1/4 text-center lg:block flex justify-center">
          <h1>
            Copyright{" "}
            <span className="mr-1 inline-block align-top">
              <Copyright className="h-4 w-4" />
            </span>
            2023 Dine Market(AHMED)
          </h1>
        </div>
        <div className="basis-1/4 text-center lg:block">
          <h1>
            Designed by{" "}
