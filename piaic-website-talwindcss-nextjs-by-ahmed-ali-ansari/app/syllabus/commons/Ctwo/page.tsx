    ...
    <>
      ...
      <div className="-mt-[140px]">
        <QuarterDataLayout
          ...
          "
          quarterContentText="CSS Flexdiv Explained – Complete Guide to Flexible Containers and Flex Items
          "
          links={
            <Link
              href={
                "https://www.freecodecamp.org/news/css-flexdiv-complete-guide/"
              }
            >
              Open guide
            </Link>
