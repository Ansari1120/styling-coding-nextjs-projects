  ...
  return (
    <>
      <div className=" rounded-b-[30%] text-center bg-[url('https://images6.alphacoders.com/456/456498.jpg')] bg-fixed bg-cover bg-no-repeat  md:px-40  px-15 py-40  ">
        ...
        <p className=" md:rounded-b-[30%] rounded-b-[15%] md:text-lg text-md md:mt-8 mt-10 font-semibold  md:mx-20 mx-5 text-black  bg-teal-100  md:opacity-60 opacity-70 p-4">
